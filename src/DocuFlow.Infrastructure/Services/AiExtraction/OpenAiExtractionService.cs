...
public class OpenAiExtractionService : IAiExtractionService
{
    ...
    {
        _logger.LogInformation("OpenAiExtractionService extracting for schema {Schema}", request.Schema);
        ...
        var response = await _httpClient.PostAsync(
            "https://api.openai.com/v1/chat/completions", content, cancellationToken);
